...
public class Calculus1 extends Mathematics{


    public Calculus1(long id, String name, double price, double edition, Person author, boolean isAvailable, StudyBooktype studyBooktype, Equations equations) {
