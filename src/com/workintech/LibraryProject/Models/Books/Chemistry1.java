...
public class Chemistry1 extends Chemistry{
    public Chemistry1(long id, String name, double price, double edition, Person author, boolean isAvailable, StudyBooktype studyBooktype, SubDisciplines subDisciplines) {
